...
class AirSimNavigatorSegmentationEnforced:
    ...
    def get_segmentation_center_label(self, window=20):
        # τραβάμε μόνο segmentation image (index 1)
        resp = self.client.simGetImages([airsim.ImageRequest(0, airsim.ImageType.Segmentation, False, False)])[0]
